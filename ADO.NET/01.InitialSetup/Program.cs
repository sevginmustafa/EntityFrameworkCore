...
namespace _01.InitialSetup
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                SqlCommand commandCreateDatabase = new SqlCommand(@"CREATE DATABASE MinionsDB", connection);
            ...
            using (connection)
            {
                SqlCommand createTables = new SqlCommand(@"CREATE TABLE Countries 
                                                           (
                ...
                SqlCommand insertData = new SqlCommand(@"INSERT INTO Countries ([Name]) VALUES 
                                                         ('Bulgaria'),
                                                         ('England'),
                                                         ('Cyprus'),
                                                         ('Germany'),
